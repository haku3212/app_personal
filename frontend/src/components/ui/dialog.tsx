...
/**
 * Diálogo modal accesible: portal, cierre con Escape / clic fuera,
 * animación de entrada y bloqueo del scroll de fondo.
 */
export function Dialog({ open, onClose, title, description, children, width }: DialogProps) {
  useEffect(() => {
    if (!open) return;
